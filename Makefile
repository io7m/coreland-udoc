...
ud_valid.o udoc udoc-conf udoc-conf.o udoc.o udr_context.o udr_debug.o \
...
obj_clean:
	...
	ud_render.o ud_table.o ud_tag.o ud_tag_st.o ud_tree.o ud_valid.o udoc udoc-conf \
	udoc-conf.o udoc.o udr_context.o udr_debug.o udr_nroff.o udr_null.o udr_plain.o \
	udr_xhtml.o
ext_clean:
